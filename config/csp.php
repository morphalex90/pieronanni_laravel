...
return [
    ...
    /*
     * Additional security headers. These values will be used by any
     * middleware or server configuration that reads this file to send
     * the corresponding HTTP headers.
     */
    'security_headers' => [
        // Recommended HSTS value: 1 year and include subdomains
        'strict_transport_security' => 'max-age=31536000; includeSubDomains',

        // Recommended Referrer-Policy
        'referrer_policy' => 'strict-origin-when-cross-origin',

        // Recommended Permissions-Policy (disable sensitive features)
